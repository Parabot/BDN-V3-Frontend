        ...
        // core utility and animation methods
            core = {
				...
				setVariables : function() {
					...
					spineCount = $('.CAspine').length - 1;
					spineSingleWd = $('.CAspine').width() * spineCount;
					slideWidth = accordion.width() - spineSingleWd;
               ...
               // next slide index
				...
				animateSlide : function(e) {
					...
					if (orientation === 'vertical') {
					    ...
					    accordion.parent().find('#'+ accordionID + '>li:eq(' + activeID + ')> div.CAslide').stop(true).animate({width: 50},settings.slideSpeed,settings.easing);
					}
